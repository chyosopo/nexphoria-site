    ...
    <SiteLayout navVariant="gate">
      ...
      <section className="py-14" style={{ backgroundColor: "var(--nx-bg-cream)", borderBottom: "1px solid var(--nx-border)" }}>
        <div className="nx-container max-w-3xl">
          ...
          <h1 style={{ fontFamily: "'General Sans', system-ui, sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 500, color: "var(--nx-fg)", lineHeight: 1.15, marginBottom: "0.5rem" }}>
            {title}
          </h1>
          <p style={{ fontFamily: "'General Sans', system-ui, sans-serif", fontSize: "10px", fontWeight: 500, letterSpacing: "0.1em", color: "var(--nx-fg-muted)" }}>
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              <Link
                ...
                style={{ fontFamily: "'General Sans', system-ui, sans-serif", fontSize: "14px", color: "var(--nx-cobalt)" }}
              >
                {label}
              </Link>
            ))}
...
export function LegalSection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-8">
      <h2 style={{ fontFamily: "'General Sans', system-ui, sans-serif", fontSize: "17px", fontWeight: 700, color: "var(--nx-fg)", marginBottom: "0.75rem", lineHeight: 1.3 }}>
        {title}
      </h2>
      {children}
    </div>
