          ...
          <div className="flex flex-col gap-0">
            {legalPages.map(({ label, href, desc }, i) => (
              <Reveal key={label} delay={i * 60}>
                ...
                >
                  <div>
                    <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "17px", fontWeight: 600, color: "var(--nx-fg)", marginBottom: "4px" }}>{label}</p>
                    <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "14px", color: "var(--nx-fg-graphite)" }}>{desc}</p>
                  </div>
