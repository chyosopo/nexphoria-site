    ...
    <SiteLayout navVariant={gender} footerVariant={gender}>
      ...
      >
        <div className="nx-container flex items-center gap-2">
          <Link href={`/${gender}/peptides`} className="flex items-center gap-1 no-underline" style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "13px", color: "var(--nx-fg-graphite)" }}>
            <ArrowLeft size={14} />
            {gender === "women" ? "Women's peptides" : "Men's peptides"}
          </Link>
          <span style={{ color: "var(--nx-border)", fontSize: "13px" }}>/</span>
          <span style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "13px", color: "var(--nx-fg)" }}>{peptide.name}</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-3">
              <Reveal>
                ...
                <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: "1.25rem", color: "var(--nx-fg-graphite)", marginBottom: "1.5rem" }}>
                  {peptide.tagline}
                </p>
                ...
                >
                  ...
                  <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "14px", color: "var(--nx-fg-graphite)", lineHeight: 1.6 }}>
                    ...
                    {[
                      ...
                      <div key={label} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "14px", fontWeight: 500, color: "var(--nx-fg)" }}>{value}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <Reveal key={i} delay={i * 60}>
                  ...
                  >
                    <div style={{ flexShrink: 0, width: "60px" }}>
                      <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", fontWeight: 500, letterSpacing: "0.1em", color: "var(--nx-cobalt)", textTransform: "uppercase" }}>
                        {entry.week}
                      </p>
                    </div>
                    <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "15px", color: "var(--nx-fg-graphite)", lineHeight: 1.6 }}>
                      {entry.effect}
                    </p>
                  </div>
                </Reveal>
            ...
            <div className="flex flex-col gap-3">
              {peptide.studies.map((study, i) => (
                <Reveal key={i} delay={i * 50}>
                  ...
                  >
                    <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "14px", fontWeight: 500, color: "var(--nx-fg)", marginBottom: "4px", lineHeight: 1.4 }}>{study.title}</p>
                    <div className="flex gap-3">
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", letterSpacing: "0.08em", color: "var(--nx-cobalt)" }}>{study.source}</span>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", letterSpacing: "0.08em", color: "var(--nx-fg-muted)" }}>{study.year}</span>
                    </div>
                  </a>
                </Reveal>
              ))}
              ...
              {peptide.pairsWith.map((pairSlug) => {
                ...
                return (
                  <Link
                    ...
                    style={{ border: "1px solid var(--nx-border)", fontFamily: "'Inter Tight', sans-serif", fontSize: "14px", fontWeight: 500, color: "var(--nx-fg)", backgroundColor: "#fff" }}
