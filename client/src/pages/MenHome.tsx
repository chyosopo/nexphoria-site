...
/* ── Physician credentials — chip row under the trust headline ── */
const CREDENTIALS = ["Board-certified", "U.S.-licensed", "MDI Providers PLLC"];

/* ── "How it works" — verbatim from COPY-BLOCKS §1, verb-first ── */
const STEPS = [
  {
    n: "01",
    Icon: ClipboardList,
...
/* Trust sections dropped into the WorldHome engine between the shelf and the
   night band. All color derives from --nx-* tokens, so they inherit the men
   (azure/steel) palette here and would inherit orchid under /women. */
function MenTrust() {
  return (
    <>
