          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {protocols.map((protocol, i) => (
              <Reveal key={protocol.slug} delay={i * 70}>
                ...
                >
                  <div>
                    <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", fontWeight: 500, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--nx-cobalt)", marginBottom: "6px" }}>
                      {protocol.peptides}
                    </p>
                    <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.5rem", fontWeight: 500, color: "var(--nx-fg)", lineHeight: 1.2, marginBottom: "4px" }}>
                      {protocol.name}
                    </h2>
                    <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: "1rem", color: "var(--nx-fg-graphite)" }}>
                      {protocol.tagline}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    {protocol.kpis.map((kpi) => (
                      <div key={kpi} className="flex items-center gap-2">
                        ...
                        <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--nx-fg-graphite)" }}>
                          {kpi}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between border-t" style={{ borderColor: "var(--nx-border)" }}>
                    <p style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: "16px", fontWeight: 700, color: "var(--nx-fg)" }}>
                      {protocol.price}
                    </p>
