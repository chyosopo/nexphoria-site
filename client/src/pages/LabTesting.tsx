        ...
        <div className="mx-page">
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, color-mix(in srgb, var(--nx-fg) 52%, transparent) 0%, color-mix(in srgb, var(--nx-fg) 10%, transparent) 36%, transparent 58%)",
              }}
            />
            <figcaption className="absolute left-0 right-0 bottom-0 p-6 md:p-10">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5">
                ...
                >
                  50+ biomarkers drawn at a partner laboratory and read by your physician — before your first dose and after your last.
                </p>
      ...
      >
        <div className="nx-container max-w-screen-xl">
          ...
          {/* {PLACEHOLDER} Panel tier names, prices, and marker counts are provisional
              until the lab menu is finalized with the partner laboratory. */}
          <div
            style={{
              display: "grid",
            ...
            {[
              {
                ...
                features: [
                  ...
                  "Results delivered in your member portal",
                ],
              },
              {
                key: "comprehensive",
                ...
                features: [
                  ...
                  "Physician review of results after receipt",
              ...
              },
              {
                ...
                features: [
                  ...
                  "Physician results consultation",
                ],
              },
              ...
              <Reveal key={key} delay={i * 60}>
                <div
                  ...
                  style={{
                    ...
                    display: "flex",
                    flexDirection: "column",
                    background: popular ? "var(--nx-fg)" : "var(--nx-ceramic)",
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: "0.5rem" }}>
                    ...
                    <p
                      style={{
                        fontFamily: "'General Sans', system-ui, sans-serif",
                        fontSize: "var(--nx-t-xs)",
                        color: popular ? "color-mix(in srgb, var(--nx-ceramic) 60%, transparent)" : "var(--nx-fg-muted)",
                      }}
                    >
                      {markers}
                    </p>
                  ...
                  <p
                    style={{
                      fontFamily: "'General Sans', system-ui, sans-serif",
                      fontSize: "var(--nx-t-xs)",
                      color: popular ? "color-mix(in srgb, var(--nx-ceramic) 70%, transparent)" : "var(--nx-fg-graphite)",
                      marginTop: "0.5rem",
                      marginBottom: "1.25rem",
                    }}
                  >
                      ...
                      <li key={f} style={{ display: "flex", gap: "0.625rem", alignItems: "flex-start" }}>
                        ...
                        <span
                          style={{
                            ...
                            fontSize: "var(--nx-t-sm)",
                            lineHeight: 1.55,
                            color: popular ? "color-mix(in srgb, var(--nx-ceramic) 85%, transparent)" : "var(--nx-fg-graphite)",
                          }}
                        >
                          {f}
                        </span>
