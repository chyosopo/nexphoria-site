...
const STEPS = [
  { t: "Answer the questions.", b: "Health history, current medicines and the goal, answered at checkout. A few minutes.", img: "img/img_329e054306f2.webp", img800: "img/img_329e054306f2-800w.webp", alt: "A woman answering questions on a tablet at a bright desk" },
      ...
      <Reveal>
        <div className="nx-sec-row">
          <div className="nx-sec-head">
            ...
            <h2 id="fd-road" className="nx-dsh2 nx-shout" style={{ maxWidth: "18ch" }}>Questions. Physician. First dose.</h2>
          </div>
          ...
          <Reveal key={s.t} delay={i * 70} className="nx-tiles__item">
            <li className="nx-tile nx-tile--photo">
              ...
              <span className="nx-tile__foot">
                <span className="nx-tile__t nx-shout" style={{ fontFamily: S }}>{s.t}</span>
