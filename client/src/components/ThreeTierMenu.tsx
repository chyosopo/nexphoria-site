      ...
      <div className="nx-container">
        ...
        <div className="max-w-3xl mb-12 md:mb-16">
          <h2
            ...
            style={{ fontFamily: "'General Sans', system-ui, sans-serif", color: "var(--nx-fg)", fontWeight: 500 }}
          >
            ...
            <Link asChild key={t.testid} href={t.href}>
              ...
              >
                ...
                <div
                  ...
                  style={{ fontFamily: "'General Sans', system-ui, sans-serif", color: "var(--nx-fg-graphite)" }}
                >
                  {t.meta}
                </div>
