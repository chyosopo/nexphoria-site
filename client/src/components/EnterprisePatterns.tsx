...
export function SectionHead({
  ...
  return (
    <div style={{ textAlign: center ? "center" : "left", marginInline: center ? "auto" : undefined, maxWidth: center ? "60ch" : undefined }}>
      ...
      <h2 style={{ fontFamily: S, fontWeight: 500, fontSize: "var(--nx-t-h2)", color: "var(--nx-fg)", marginTop: eyebrow ? "0.8rem" : 0, lineHeight: 1.1, letterSpacing: "var(--nx-ls-snug)", maxWidth: center ? undefined : maxTitle, marginInline: center ? "auto" : undefined }}>
        {title}
      </h2>
      {lead && (
