 ...
 */
/* The mark alone (2026-09-15): the loop layer draws it at the centre of
   the goal orbit on the home. `ink` is any CSS colour. */
export function LogoMark({ size = 28, ink = "currentColor", className = "" }: { size?: number; ink?: string; className?: string }) {
  return (
    <svg
      width={size}
      height={size * (500 / 600)}
...
export function Logo({
  ...
  return (
    ...
    >
      ...
      <LogoMark size={markSize} ink={ink} />
