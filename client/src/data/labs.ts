...
export const LAB_ADDONS: LabAddon[] = [
  {
    ...
    recommendedLine: "Recommended with testosterone and kisspeptin, where the axis is the point.",
  },
  {
    ...
    recommendedLine: "Recommended with testosterone.",
  },
  {
    ...
    recommendedLine: "Recommended where energy, mood or sleep is the goal.",
  },
  {
    ...
    recommendedLine: "Recommended with a GLP-1 plan, and for healthy ageing.",
  },
  {
    ...
    recommendedLine: "Recommended with semaglutide, tirzepatide and tesamorelin.",
  },
  {
    ...
    recommendedLine: "Recommended with thymosin alpha-1 and the recovery peptides.",
  },
  {
    ...
    recommendedLine: "Recommended for energy and sleep goals.",
  },
  {
    ...
    recommendedLine: "Recommended where a medicine is cleared by the liver or the kidneys.",
  },
];
