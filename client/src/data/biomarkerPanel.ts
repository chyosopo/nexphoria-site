...
const BLURBS: Record<string, string> = {
  "Sugar and insulin": "How your body handles food. Usually the first thing a weight plan changes, and the clearest proof it is working.",
  "Cholesterol and heart": "The numbers your doctor tracks for heart risk over time, and what weight change and tesamorelin are expected to move.",
  "Liver, kidneys and pancreas": "The organs that process your medication. Your doctor checks they are handling it well.",
  "Hormones": "Energy, muscle, desire, thyroid and stress. Context for how you feel, and the number tesamorelin's dose is set against.",
