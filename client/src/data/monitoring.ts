...
export const FULL_PANEL: PanelGroup[] = [
  ...
  },
  {
    ...
    markers: [
      ...
      { name: "Vitamin D", why: "Commonly low. Affects bone, mood and immunity." },
...
export const PEPTIDE_MONITORING: PeptideMonitoring[] = [
  ...
  },
  {
    ...
    why: "This peptide works on the brain. Your week-12 blood test checks thyroid and cortisol, which shape mood and focus on their own, so your physician can read the whole picture.",
  ...
  },
  {
    ...
    why: "A ten-day course by injection. Your week-12 blood test checks kidney and liver markers so your physician can confirm it was handled well.",
  ...
  },
  {
    ...
    why: "Taken daily as a capsule. Your week-12 blood test checks blood count and liver markers.",
  ...
  },
  {
    ...
    why: "This peptide supports repair. Your week-12 blood test checks inflammation, blood count and liver markers so your physician can see how your body is responding.",
  ...
  },
  {
    ...
    why: "This peptide supports collagen and skin repair. Your week-12 blood test checks inflammation and blood count.",
  ...
  },
  {
    ...
    why: "This peptide works on cellular energy and metabolism. Your week-12 blood test checks blood sugar, insulin, inflammation and cortisol so your physician can see the response.",
  ...
  },
  {
    ...
    why: "This peptide works on sleep. Your week-12 blood test checks cortisol and thyroid, which shape sleep on their own.",
    watch: ["Cortisol", "TSH"],
