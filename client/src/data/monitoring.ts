...
export const PEPTIDE_MONITORING: PeptideMonitoring[] = [
  {
    ...
    why: "This medicine changes how your body handles food and sugar. At week 12 your blood shows your doctor what it changed, and whether the dose is right.",
  ...
  },
  {
    ...
    why: "Tirzepatide works on two hunger and sugar signals at once. At week 12 your blood shows your doctor what it changed, and whether the dose is right.",
    watch: ["HbA1c", "Fasting glucose", "Fasting insulin", "Triglycerides", "Lipase", "ALT and AST"],
    intakeScreens: [
      "Personal or family history of medullary thyroid cancer or MEN 2",
      "History of pancreatitis",
  ...
  },
  {
    ...
    why: "Tesamorelin asks your body to release more of its own growth hormone. The right dose is a number in your blood, IGF-1, and the medicine can nudge blood sugar, so your doctor reads both at week 12.",
  ...
  },
  {
    ...
    why: "PT-141 works on desire through the brain, not through hormones. The screen is your heart and your blood pressure, because a dose raises pressure for a few hours. At week 12 your doctor reads your hormones for context.",
