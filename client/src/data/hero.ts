...
export const HERO = {
  ...
  subline:
    "A U.S. doctor writes your plan from your questionnaire. Made for you in a licensed U.S. pharmacy, delivered cold. At week 12 a full blood panel, included, shows what changed.",
  ...
  chips: ["U.S. licensed doctors", "Licensed 503A pharmacy", "Full blood panel at week 12, included", "Ships cold, all 50 states"],
};
