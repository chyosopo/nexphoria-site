...
const ALL_SOLO: SoloPeptide[] = [
  /* ── GROWTH / GH-AXIS ── */
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose, at bedtime." }, { wk: "Wk 4", effect: "Taken nightly." }, { wk: "Wk 12", effect: "Your blood test. IGF-1 is read first." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose, in the evening." }, { wk: "Wk 8", effect: "The same dose daily." }, { wk: "Wk 12", effect: "Your blood test. IGF-1 is read first." }],
  ...
  /* ── COGNITIVE ── */
  {
    ...
    timeline: [{ wk: "Day 1", effect: "Your first spray." }, { wk: "Wk 2", effect: "Taken twice a day." }, { wk: "Wk 12", effect: "Your blood test. Thyroid and cortisol are read for context." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Day 1", effect: "Your first spray, in the morning." }, { wk: "Wk 2", effect: "Taken daily." }, { wk: "Wk 12", effect: "Your blood test. Thyroid and cortisol are read for context." }],
    panel: "Full",
    contraindications: ["Pregnancy", "Concurrent psychiatric medication (physician review)"],
    pricing: { m1: 189, m3: 170, m6: 161, m12: 151 },
    status: "coming", feelBy: "Same day to 1 week", fullEffect: "2 to 4 weeks", evidence: 2,
  ...
  },
  {
    ...
    timeline: [{ wk: "Day 1", effect: "Your course begins." }, { wk: "Day 10", effect: "Your course ends." }, { wk: "Wk 12", effect: "Your blood test. Kidney and liver markers are read." }],
    panel: "Full",
  ...
  },
  {
    ...
    timeline: [{ wk: "Day 1", effect: "Your first capsule." }, { wk: "Wk 4", effect: "Taken daily." }, { wk: "Wk 12", effect: "Your blood test. Blood count and liver markers are read." }],
    panel: "Full",
  ...
  /* ── RECOVERY ── */
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 4", effect: "Taken daily through your recovery." }, { wk: "Wk 12", effect: "Your blood test. Inflammation markers are read." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 4", effect: "Twice a week through your recovery." }, { wk: "Wk 12", effect: "Your blood test. Inflammation markers are read." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first doses." }, { wk: "Wk 4", effect: "Both peptides through your recovery." }, { wk: "Wk 12", effect: "Your blood test. Inflammation markers are read." }],
    panel: "Full", panelNote: "The blood test at week 12, included. IL-6 and hs-CRP are read first.",
    contraindications: ["Active malignancy", "Pregnancy or lactation"],
  ...
  /* ── SKIN & LONGEVITY ── */
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 6", effect: "Taken daily. Skin renews on its own cycle." }, { wk: "Wk 12", effect: "Your blood test. Inflammation markers and blood count are read." }],
    panel: "Full",
  ...
  },
  {
    ...
    timeline: [{ wk: "Day 1", effect: "Your course begins." }, { wk: "Day 20", effect: "Your course ends." }, { wk: "Wk 12", effect: "Your blood test. Metabolic and inflammation markers are read." }],
    panel: "Full",
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first doses." }, { wk: "Wk 4", effect: "Three times a week." }, { wk: "Wk 12", effect: "Your blood test. Metabolic and inflammation markers are read." }],
    panel: "Full",
    contraindications: ["Active malignancy", "Pregnancy"],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 4", effect: "Twice a week, alongside training." }, { wk: "Wk 12", effect: "Your blood test. Metabolic markers are read." }],
    panel: "Full",
    contraindications: ["Active malignancy", "Pregnancy"],
  ...
  /* ── METABOLIC / GLP-1 (GATED) ── */
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose, at the lowest step." }, { wk: "Wk 4", effect: "Your dose steps up." }, { wk: "Wk 12", effect: "Your blood test and a dose review." }],
  ...
  /* ── SLEEP + SEXUAL HEALTH ── */
  {
    ...
    timeline: [{ wk: "Night 1", effect: "Your first dose, at bedtime." }, { wk: "Wk 2", effect: "Taken nightly." }, { wk: "Wk 12", effect: "Your blood test. Cortisol and thyroid are read." }],
    panel: "Full",
  ...
  },
  {
    ...
    timeline: [{ wk: "Dose 1", effect: "Taken about an hour ahead. Works within 1 to 3 hours." }, { wk: "Ongoing", effect: "On the days you choose, within the monthly limit." }, { wk: "Wk 12", effect: "Your blood test and a dose review." }],
  ...
  /* ── ADDED FROM THE PLAYBOOK (2026-09-04) ── */
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first doses." }, { wk: "Wk 4", effect: "Taken through the season." }, { wk: "Wk 12", effect: "Your blood test. Blood count and inflammation markers are read." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 6", effect: "Taken daily alongside your main plan." }, { wk: "Wk 12", effect: "Your blood test. Metabolic markers are read." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Dose 1", effect: "Taken shortly before." }, { wk: "Ongoing", effect: "On the days you choose." }, { wk: "Wk 12", effect: "Your blood test. Hormones are read for context." }],
    panel: "Full", panelNote: "The blood test at week 12, included. Hormones are read for context.",
  ...
  },
  {
    ...
    timeline: [{ wk: "Dose 1", effect: "About 20 to 30 minutes ahead." }, { wk: "Ongoing", effect: "On the days you choose." }, { wk: "Wk 12", effect: "Your blood test. Heart markers are read for context." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 6", effect: "Levels settle." }, { wk: "Wk 12", effect: "Your blood test. Testosterone, estradiol and blood count are read first." }],
  ...
  },
  {
    ...
    timeline: [{ wk: "Wk 1", effect: "Your first dose." }, { wk: "Wk 6", effect: "Taken on schedule." }, { wk: "Wk 12", effect: "Your blood test. Testosterone, estradiol and SHBG are read first." }],
