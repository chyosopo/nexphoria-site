...
export interface SoloPeptide {
  ...
  feelBy?: string;
  /** What to expect, in plain words (the nuform study, 2026-09-24): what
      people notice first and when, what builds later, and what the medicine
      is slow at. Derived from mechanism, feelBy and fullEffect; facts and
      hedges only, never a promise. Rendered at the top of "The first twelve
      weeks" on the product page. */
  expect?: string;
  fullEffect?: string;
...
const ALL_SOLO: SoloPeptide[] = [
  /* ── GROWTH / GH-AXIS ── */
  {
    ...
    expect: "Sleep is usually the first thing people notice, within two to four weeks: deeper, and easier to fall into. Recovery and lean mass follow over eight to twelve weeks, alongside training. It builds gradually, so a change in the first week is unusual. Your own gland does the work; the peptide only sends the signal.",
  ...
  },
  {
    ...
    expect: "Sleep usually changes within the first week. Recovery and lean mass build over eight to twelve weeks, and only alongside training. The rise is gentle, without the cortisol or prolactin bump some secretagogues bring.",
    timeline: [{ wk: "Wk 1", effect: "You take the first dose at bedtime." }, { wk: "Wk 4", effect: "You take it nightly." }, { wk: "Wk 12", effect: "You draw the same panel again, and IGF-1 is read first." }],
    panel: "Full", panelNote: "The blood test at week 12, included. IGF-1 is read first.",
    contraindications: ["Active malignancy", "Elevated IGF-1 at baseline"],
  ...
  },
  {
    ...
    expect: "On its own it is a quiet medicine: sleep in the first week or two, then recovery and lean mass over eight to twelve weeks. Most physicians pair it with ipamorelin, so the two act on the same overnight pulse.",
    timeline: [{ wk: "Wk 1", effect: "You take the first dose at bedtime." }, { wk: "Wk 4", effect: "You take it nightly." }, { wk: "Wk 12", effect: "You draw the same panel again, and IGF-1 is read first." }],
    panel: "Full", panelNote: "The blood test at week 12, included. IGF-1 is read first.",
    contraindications: ["Active malignancy", "Elevated IGF-1 at baseline"],
  ...
  },
  {
    ...
    expect: "Sleep changes within the first week for most people. Recovery follows in the first month, lean mass over eight to twelve weeks alongside training. It is gradual by design: your own overnight pulse is being lifted, so the change arrives at your body's own pace.",
    timeline: [{ wk: "Wk 1", effect: "You take the first dose at bedtime." }, { wk: "Wk 4", effect: "You take it nightly." }, { wk: "Wk 12", effect: "You draw the same panel again, and IGF-1 is read first." }],
    panel: "Full", panelNote: "The blood test at week 12, included. IGF-1 is read first.",
    contraindications: ["Active malignancy", "Elevated IGF-1 at baseline"],
  ...
  },
  {
    ...
    expect: "Deep abdominal fat is typically the first thing to shift, at four to eight weeks, and IGF-1 in your blood sets the dose. The full effect is read at twelve weeks and beyond. It is gradual; the physician reads the week-12 panel before deciding whether it continues.",
  ...
  /* ── COGNITIVE ── */
  {
    ...
    expect: "Some people feel a steadier mood the same day; for others it takes a week. The full effect settles in two to four weeks. It is calm rather than stimulating, and it wears off between doses, which is why it is taken twice a day.",
  ...
  },
  {
    ...
    expect: "Focus and mental stamina build over one to two weeks, with the full effect at two to four. It is a morning spray, and the change is clarity rather than stimulation.",
  ...
  },
  {
    ...
    expect: "A ten-day course, taken as one block. Any change in clarity or recovery is usually noticed in the weeks after the course rather than during it, and the full effect is read at four to eight weeks.",
  ...
  },
  {
    ...
    expect: "At a low daily dose, mental clarity and stamina are the usual first change, over one to two weeks, with the full effect at four to eight. Urine turns blue-green while it is taken; that is the dye leaving the body.",
  ...
  /* ── RECOVERY ── */
  {
    ...
    expect: "Where gut symptoms are present, they often ease within days. Tendon, muscle and joint recovery follow over one to two weeks, with the full effect at four to eight. It works at the site of an injury, so a body with nothing to repair notices less.",
  ...
  },
  {
    ...
    expect: "Stiffness and recovery time are usually the first things to shift, at two to three weeks. Tissue repair builds to six to eight weeks. It is taken twice a week, and the human evidence is early, which the evidence label on this page states.",
  ...
  },
  {
    ...
    expect: "Gut symptoms, where present, ease within days. Recovery and stiffness shift over one to three weeks, and tissue repair builds to six to eight. The two act on the same injury from two directions, which is why they are prescribed together.",
  ...
  /* ── SKIN & LONGEVITY ── */
  {
    ...
    expect: "Skin renews on a cycle of about four weeks, so the first change in firmness and texture comes at three to four weeks, and it builds to eight to twelve. Wound and scar healing tend to be noticed sooner than overall elasticity.",
  ...
  },
  {
    ...
    expect: "Sleep is usually the first change, within one to two weeks of a course. The rest of what it is studied for, telomere maintenance, is read in the lab rather than felt. It is taken as a 20-day course a few times a year, and the effect is judged per course.",
  ...
  },
  {
    ...
    expect: "Energy is the usual first change, in days to two weeks, and recovery follows. The effect is maintained rather than built, so it continues for as long as it is taken. The injection can sting for a moment, and the physician sets the pace.",
  ...
  },
  {
    ...
    expect: "It builds over eight to twelve weeks, and only alongside training: endurance and metabolism are what it is studied for, and the first change is usually noticed in the second to fourth week. Without exercise it does little.",
  ...
  /* ── METABOLIC / GLP-1 (GATED) ── */
  {
    ...
    expect: "Appetite usually quiets in the first week: you feel full sooner and think about food less. Weight changes over months, and the dose is stepped up over the first weeks to keep the stomach settled. Nausea, constipation and a full feeling are common early and usually ease; the physician adjusts the pace.",
  ...
  },
  {
    ...
    expect: "Appetite usually quiets in the first week, and blood sugar steadies with it. Weight changes over months, and the dose is stepped up over the first weeks to keep the stomach settled. Nausea, constipation and a full feeling are common early and usually ease; the physician adjusts the pace.",
    timeline: [{ wk: "Wk 1", effect: "You take the first dose, at the lowest step." }, { wk: "Wk 4", effect: "Your dose steps up." }, { wk: "Wk 12", effect: "You draw the same panel again, and the physician reviews your dose." }],
    panel: "Full", panelNote: "The blood test at week 12, included. Fasting insulin and lipase are read first.",
    contraindications: ["Personal/family history of medullary thyroid carcinoma", "MEN 2", "Pregnancy", "Pancreatitis history"],
    stateExclusions: ["AK", "AR", "IN", "MI", "MN", "SC"],
  ...
  /* ── SLEEP + SEXUAL HEALTH ── */
  {
    ...
    expect: "Many people notice it from the first nights: falling asleep faster, more deep sleep. The effect is nightly rather than cumulative, so it continues for as long as it is taken. The evidence is early, which the evidence label on this page states.",
  ...
  },
  {
    ...
    expect: "It acts the same day, about 45 minutes after the dose, and stays active for several hours. It works on desire rather than blood flow, so it is often paired with tadalafil. Flushing and nausea can come with the first doses.",
  ...
  /* ── ADDED FROM THE PLAYBOOK (2026-09-04) ── */
  {
    ...
    expect: "Immune resilience is felt indirectly: fewer setbacks under stress and quicker recovery, over two to four weeks. There is little to notice day to day, and the effect is maintained rather than built.",
  ...
  },
  {
    ...
    expect: "Any change comes over weeks, alongside a broader plan, and the human evidence is limited, which the evidence label on this page states. It is offered as an addition to a metabolic plan rather than as the plan itself.",
  ...
  },
  {
    ...
    expect: "It acts the same day, shortly after the spray, on closeness and arousal. It is taken on the days you choose, and often alongside PT-141.",
  ...
  },
  {
    ...
    expect: "It acts in 20 to 30 minutes and works on blood flow. It is taken on the days you choose; PT-141 works on desire, and the two are often paired.",
  ...
  },
  {
    ...
    expect: "Energy, mood and drive are usually the first change, at two to six weeks. Muscle and body composition follow over three to six months alongside training. The dose is set from your total and free testosterone and adjusted from the week-12 panel. It is a long-term medicine, and stopping returns your level to where it was.",
  ...
  },
  {
    ...
    expect: "It works one step above your own hormones, so the change is gradual, over weeks, and read in the panel before it is felt. It is chosen to keep your own production working, and in fertility-minded plans.",
