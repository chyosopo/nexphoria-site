/* ═══ OUTCOME IMAGERY — the C29 photography law, resolved to local assets ═══
   ...
   Paths are ROOT-ABSOLUTE (/img/…): after the switch to browser path routing,
   a bare relative "img/…" resolved against the current route and 404'd on every
   multi-segment path (/men/peptides, /men/peptides/:slug, /stacks/:slug). The
   leading slash pins them to the site root regardless of route depth. */
