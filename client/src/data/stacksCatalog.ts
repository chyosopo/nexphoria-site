...
const ALL_STACKS: FlagshipStack[] = [
  {
    ...
    timeline: [
      { wk: "Wk 1", effect: "The first doses." },
      { wk: "Wk 4", effect: "Nightly and daily, through your recovery." },
      { wk: "Wk 12", effect: "The panel is repeated. IGF-1 and inflammation markers are read first." },
    ],
    panel: "Full",
  ...
  },
  {
    ...
    timeline: [
      ...
      { wk: "Wk 12", effect: "The panel is repeated. Metabolic and inflammation markers are read." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      ...
      { wk: "Wk 12", effect: "The panel is repeated. Thyroid and cortisol are read for context." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      ...
      { wk: "Ongoing", effect: "On the days chosen, within the monthly limit." },
      { wk: "Wk 12", effect: "The panel is repeated. Hormones and heart markers are read for context." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      { wk: "Wk 1", effect: "The first dose." },
      { wk: "Wk 6", effect: "Levels settle." },
      { wk: "Wk 12", effect: "The panel is repeated. Testosterone, estradiol and blood count are read first." },
    ],
    panel: "Full",
