...
const cad = (base: number): StackCadence[] => [
  { key: "1mo", label: "One month", sublabel: "Paid up front", total: base, perMonth: base, labs: "Blood kit before the first dose, included" },
...
const ALL_STACKS: FlagshipStack[] = [
  {
    ...
    timeline: [
      { wk: "Wk 1", effect: "You take the first doses." },
      { wk: "Wk 4", effect: "You take them nightly and daily, through your recovery." },
      { wk: "Wk 12", effect: "You draw the same panel again, and IGF-1 and inflammation markers are read first." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      { wk: "Wk 1", effect: "You take the first doses." },
      { wk: "Wk 6", effect: "You take them on schedule, and your skin renews on its own cycle." },
      { wk: "Wk 12", effect: "You draw the same panel again, and metabolic and inflammation markers are read." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      { wk: "Day 1", effect: "You take your first sprays." },
      { wk: "Wk 2", effect: "You take them daily." },
      { wk: "Wk 12", effect: "You draw the same panel again, and thyroid and cortisol are read for context." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    timeline: [
      { wk: "Wk 1", effect: "You take the first dose, at the lowest step." },
      { wk: "Wk 4", effect: "Your dose steps up." },
      { wk: "Wk 12", effect: "You draw the same panel again, and the physician reviews your dose." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12. Fasting insulin and lipase are read first.",
  ...
  },
  {
    ...
    timeline: [
      { wk: "Dose 1", effect: "You take it about an hour ahead, and it works the same day." },
      { wk: "Ongoing", effect: "On the days you choose, within the monthly limit." },
      { wk: "Wk 12", effect: "You draw the same panel again, and hormones and heart markers are read for context." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12.",
  ...
  },
  {
    ...
    peptides: [
      ...
      { name: "Kisspeptin", dose: "On the physician's schedule, under the skin", spec: "Vial" },
    ],
    ...
    timeline: [
      { wk: "Wk 1", effect: "You take the first dose." },
      { wk: "Wk 6", effect: "Your levels settle." },
      { wk: "Wk 12", effect: "You draw the same panel again, and testosterone, estradiol and your blood count are read first." },
    ],
    panel: "Full",
    panelNote: "A blood test before the first dose, and the same test at week 12. Hormones are read first.",
...
export const SAME_JOB: SameJobGroup[] = [
  { name: "Growth hormone peptides", members: ["Sermorelin", "Ipamorelin / CJC-1295 Blend", "Tesamorelin"], note: "All three raise your own growth hormone. Pick one; the physician chooses by goal." },
  { name: "GLP-1 medications", members: ["Semaglutide", "Tirzepatide"], note: "One at a time. Tirzepatide works on a second hormone; the physician picks." },
];
...
export const PANELS: PanelDef[] = [
  {
    ...
    summary: "The full panel, drawn at home before the first dose.",
