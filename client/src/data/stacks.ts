...
export const stacks: Stack[] = [
  {
    ...
    purpose: "Studied for tendon, ligament, and soft-tissue recovery from training.",
    curator: "Board-certified physician — Sports Medicine",
    description: "Three peptides working in concert: BPC-157 is studied for local repair signaling, TB-500 for systemic cellular migration, GHK-Cu for collagen synthesis. Tracks CRP, ESR, and CK-MB to confirm inflammatory resolution.",
  ...
  },
  {
    ...
    purpose: "Studied for dermal collagen, skin tone, and metabolic skin support.",
  ...
  },
  {
    ...
    purpose: "Mitochondrial function, telomere health, and biological-age markers.",
    curator: "Board-certified physician — Internal Medicine",
