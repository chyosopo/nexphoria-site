...
export const HORIZON: Record<string, Horizon> = {
  ...
  "bpc-157": w([0, 2], "Gut symptoms within days; tissue in 1 to 2 weeks", [4, 8], "Weeks 4 to 8"),
  "tb-500": w([2, 3], "Weeks 2 to 3", [6, 8], "Weeks 6 to 8"),
  "bpc-tb-combo": w([0, 3], "Gut symptoms within days; tissue in 1 to 3 weeks", [6, 8], "Weeks 6 to 8"),
  ...
  "thymosin-a1": w([2, 4], "Weeks 2 to 4", "ongoing", "While you take it"),
  "aod-9604": w([2, 6], "Weeks", [12, 12], "Week 12"),
  testosterone: w([2, 6], "Energy and drive, weeks 2 to 6", [12, 26], "Body, months 3 to 6"),
  kisspeptin: w([2, 6], "Weeks", "ongoing", "Your own production, while you take it"),
