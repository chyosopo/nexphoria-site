...
export const orgJsonLd = (): Record<string, unknown> => ({
  ...
  description:
    "Prescription peptide therapy, with a physician and a blood panel. Compounded peptide medicines, prescribed by licensed U.S. physicians and compounded in a licensed U.S. pharmacy.",
